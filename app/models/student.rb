...
class Student < ActiveRecord::Base
	...
	#student also takes on the nested attributes associated with each of the jobs under it
	...
	#student also takes on/allows the attributes of the contacts associated with it
